...
int main(int argc, char** argv)
{
	...
	std::ofstream File("SimulatedDataWT,N=128.csv");
	if(!File.is_open())
	{
	...
	File << "\"L\",""\"Eb/N0\", \"Rate\", \"Runs\", \"Errors\",\"Time\",\"Blockspeed\",\"Coded Bitrate\",\"Payload Bitrate\"" << std::endl;
