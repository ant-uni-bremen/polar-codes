...
void ButterflyFipTransform(fipv* bitVector,
                           size_t blockLength,
                           int stage,
                           const int bitsPerExpandedBit);
void ButterflyFipTransformSubVector(fipv* bitVector,
                                    int stage,
                                    int blockCount,
                                    const int bitsPerExpandedBit);
void ButterflyFipTransformCrossVector(fipv* bitVectors,
                                      int stage,
                                      int blockCount,
                                      const int logsize);
