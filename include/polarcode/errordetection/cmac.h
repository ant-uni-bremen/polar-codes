 ...
 */
        class cmac : public Detector {
            ...
            size_t calculate_cmac_len(unsigned char* cmac, const unsigned int cmac_len, const unsigned char* key, const unsigned int key_len, const unsigned char* message, const unsigned int msg_len);
            size_t calculate_cmac(unsigned char* cmac, const unsigned char* key, const unsigned int key_len, const unsigned char* message, const unsigned int msg_len);
