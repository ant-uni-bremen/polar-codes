...
public:
    ...
    /*!
     * \brief Create a virtual copy of the given block by increasing the reference
     * counter. \param block The block (not) to copy. \return The same pointer to imitate
     * a copy operation.
     */
