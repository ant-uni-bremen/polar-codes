...
/*
   ...
   Edited by Florian Lotze, as AVX2 wasn't actually used, somehow.
   + Added FMA support.
...
inline v8sf log256_ps(v8sf x)
{
...
#ifndef __AVX2__
    imm0 = _mm256_srli_epi32_sse2(_mm256_castps_si256(x), 23);
#else
    ...
    */
    ...
    y = _mm256_fmadd_ps(z, *(v8sf*)_ps256_0p5n, y);
...
_PS256_CONST(cephes_exp_C1n, -0.693359375f);
...
#else
    x = _mm256_fmadd_ps(fx, *(v8sf*)_ps256_cephes_exp_C1n, x);
#endif
    x = _mm256_sub_ps(x, z);
...
{ // any x
    ...
    */
    ...
    y = _mm256_sub_ps(y, tmp);
#else
    y = _mm256_fmadd_ps(y, z, *(v8sf*)_ps256_coscof_p1);
...
#else
    y2 = _mm256_fmadd_ps(y2, z, *(v8sf*)_ps256_sincof_p1);
...
/* since sin256_ps and cos256_ps are almost identical, sincos256_ps could replace both of
