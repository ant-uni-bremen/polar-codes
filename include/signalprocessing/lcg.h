...
public:
	...
	__m256 operator()() {
		x = _mm256_add_epi32_sse2(_mm256_mullo_epi32_sse2(x, *(__m256i*)_ps256_lcg_a), *(__m256i*)_ps256_lcg_b);
		__m256i u = _mm256_or_si128_sse2(_mm256_srli_epi32_sse2(x, 9), *(__m256i*)_ps256_lcg_mask);
