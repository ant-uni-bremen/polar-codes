...
RepSPC(LLR[0][3].data(), Bits[0][3][1].data(), 8, Bits[0][2][0].data(), Bits[0][2][1].data());
Combine_0R(Bits[0][3][1].data(), Bits[0][4][1].data(), 8);
Combine_0R(Bits[0][4][1].data(), Bits[0][5][0].data(), 16);
...
F_function_vectorized(LLR[0][4].data(), LLR[0][3].data(), 8);
RepSPC(LLR[0][3].data(), Bits[0][3][0].data(), 8, Bits[0][2][0].data(), Bits[0][2][1].data());
G_function_vectorized(LLR[0][4].data(), LLR[0][3].data(), Bits[0][3][0].data(), 8);
