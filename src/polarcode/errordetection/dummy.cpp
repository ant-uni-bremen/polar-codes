...
unsigned Dummy::getCheckBitCount() { return 0; }

std::string Dummy::getType() { return std::string("DUMMY"); }

// Null check believes the code was okay
bool Dummy::check(void* dataPtr, int bytes) { return true; }
...
int Dummy::multiCheck(void** dataPtr, int nArrays, int nBytes) { return 0; }
